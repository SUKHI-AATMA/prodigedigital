...
function loadui() {
 ...
 <div class="one3d-object-wrapper">
     ...
     <div class="one3d-toggle-color">
         ...
         <p class="device-tooltip-content">abc</p>
     </div>
...
//production code UA-180930252-1
_gaq.push(['_setAccount', 'UA-180930252-2']);
...
$(function () {
    ...
    if ($(".one3d-toggle-color-selected").length) {
        ...
        $(".one3d-toggle-color .one3d-toggle-color-options ul").find("li").on("click", function () {
            ...
            $(this).parents(".one3d-toggle-color").find(".device-tooltip-content").text($(this).attr("title"));
        ...
        $(".one3d-toggle-color").find(".device-tooltip-content").text($(".one3d-toggle-color .one3d-toggle-color-options ul").find("li").eq(0).attr("title"));
    }
    /** Color Swatches ends **/
    ...
    if ($(".one3d-toggle-view-box").length) {
        $(".one3d-toggle-view-box label").on("click", function () {
